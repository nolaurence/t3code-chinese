...
export const ClientSettingsSchema = Schema.Struct({
  ...
  showAssistantReasoning: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
});
...
export const PiAgentSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "Pi agent home path",
        description: "Custom Pi config directory exposed as PI_CODING_AGENT_DIR.",
        providerSettingsForm: {
...
export const OmpSettings = makeProviderSettingsSchema(
  {
    ...
    homePath: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "Oh My Pi home path",
        description: "Custom Oh My Pi config directory exposed as PI_CODING_AGENT_DIR.",
        providerSettingsForm: {
...
export class CopilotLlmProviderModelDiscoveryError extends Schema.TaggedError<CopilotLlmProviderModelDiscoveryError>()(
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  showAssistantReasoning: Schema.optionalKey(Schema.Boolean),
});

...
export type DesktopAppStageLabel = "Alpha" | "Browser" | "Dev" | "Nightly";
...
export const DesktopAppStageLabelSchema = Schema.Literals(["Alpha", "Browser", "Dev", "Nightly"]);
...
export interface DesktopPreviewBridge {
  ...
  automation: {
    /** Optional only so a newer renderer can safely run against an older desktop preload. */
    readonly supportedFeatures?: ReadonlyArray<PreviewAutomationFeature>;

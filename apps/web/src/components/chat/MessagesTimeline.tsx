...
export const MessagesTimeline = memo(function MessagesTimeline({
  ...
  const showAssistantReasoning = useClientSettings((settings) => settings.showAssistantReasoning);
  ...
  return (
    <div className="min-h-7">
      {isPreparingWorktree || isCompacting ? null : (
        <LiveActivityRow label={t("chat.reasoning.thinking")} iconName="brain" active shimmer />
      )}
    </div>
  );
}

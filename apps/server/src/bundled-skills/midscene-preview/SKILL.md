...
- Report Midscene configuration errors directly, including missing model environment variables. Do not work around them by launching another browser system.
